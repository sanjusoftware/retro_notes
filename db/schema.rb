...
ActiveRecord::Schema.define(version: 20160425060819) do
  ...
  create_table "matches", force: :cascade do |t|
    t.integer  "retro_card_id"
    t.integer  "matched_retro_card_id"
    t.datetime "created_at",            null: false
    t.datetime "updated_at",            null: false
  end

  add_index "matches", ["matched_retro_card_id"], name: "index_matches_on_matched_retro_card_id"
  add_index "matches", ["retro_card_id", "matched_retro_card_id"], name: "index_matches_on_retro_card_id_and_matched_retro_card_id", unique: true
  add_index "matches", ["retro_card_id"], name: "index_matches_on_retro_card_id"
